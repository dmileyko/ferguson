                ...
                <?php if ($this->current_user) { ?>                        
                    <div class="dropdown inline">
                        <a href="#" class="btn btn-primary current-user-link" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img src="<?php echo $this->current_user->photo; ?>" height="40" class="img-circle" />
                            <?php echo $this->current_user->firstname . ' ' . $this->current_user->lastname; ?>
                            <span class="caret"></span>
                        </a>                    
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">                   
                            <a class="dropdown-item pull-right" href="map">Map&nbsp;&nbsp;&nbsp;</a><br />  
                            <a class="dropdown-item pull-right" href="home/logout">Logout&nbsp;&nbsp;&nbsp;</a>
                        </div>
                    </div>
                <?php } ?>
            </div>
